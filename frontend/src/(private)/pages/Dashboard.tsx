import { SearchIcon, OfflineIcon, NotificationBellIcon, SixDotsIcon, EditIcon, AddSongIcon, SetlistIcon, SuccessCheckIcon, CalendarIcon } from "../../components/icons";
        ...
        return(
             <div className="w-full h-full">
               ...
               <div className="px-[24px]">
                ...
                <section className="h-[68px] flex justify-between items-center mt-[32px]">
                    <div>
