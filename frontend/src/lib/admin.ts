...
import { purgeUserStorage } from "./auth";
...
export async function adminDeleteAccount(userId: string) {
  await purgeUserStorage(userId).catch(() => undefined);
...
const TRACKED_FIELDS: Record<string, string[]> = {
  ...
  setlists: ["name", "service_type", "service_at", "est_duration_seconds", "archived_at"],
  setlist_items: ["title", "subtitle", "item_type", "duration_seconds"],
  sermons: ["title", "speaker_name", "primary_scripture", "series_name", "status", "archived_at"],
